<template>
  <div class='container'>
    <Header page='development'></Header>
    <div class="content">
      <div class="tags-box">
        <Tags :list='developSubType' @onClickTag="onClickTag"></Tags>
      </div>
      <div class="article-box">
        <ArticleS v-if="articleList.length>0" :list='articleList' :isLoading="isLoading" :isEnd="isEnd" @getMoreData="getMoreData"></ArticleS>
